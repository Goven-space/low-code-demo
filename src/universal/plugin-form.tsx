...
import {
    ...
    plugins,
    /* skeleton, */ project /* , setters */,
} from '@alilc/lowcode-engine';
import AliLowCodeEngineExt from '@alilc/lowcode-engine-ext';
import { Button, /* Icon, Overlay, */ Breadcrumb } from '@alifd/next';
...
import { getPageSchema, saveSchema, resetSchema, preview, formPreview } from './utils';
import assetsForm from '../../public/assets-form.json';
...
var _pane = _interopRequireDefault(require('@alilc/lowcode-plugin-datasource-pane/lib/pane'));
console.log(window.location);
const hrefUrl = window.location.href.indexOf('processDesign') == -1;
    ...
    const editorInit = (ctx: ILowCodePluginContext) => {
        return {
            ...
            async init() {
                ...
                material.setAssets(await injectAssets(assetsForm));
        ...
        return {
            ...
            async init() {
                ...
                skeleton.add({
                    ...
                    content: (
                        <Button type="primary" onClick={hrefUrl ? preview : formPreview}>
                            预览
                        </Button>
                    ),
                });
